...
to match
  ...
  while [i < N ] ;; loop on offers
    ...
    [ ;; define a random productivity
      ...
      let new-match ( list  index-company best-seeker init-productivity init-satisfaction)
    ...
    if state = "employed" [
      ...
      while [ i < N ][
        ...
        if employee-id = who [
          ...
          let new-match (list company-id employee-id old-productivity new-satisfaction)
    ...
    if state = "employed" [
      ...
      while [ i < N ][
        ...
        if employee-id = who [
          ...
          let new-match (list company-id employee-id new-productivity old-satisfaction)
          set matchings replace-item i matchings new-match
          ]
        ]
        set i i + 1
